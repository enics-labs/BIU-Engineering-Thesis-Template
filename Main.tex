...
%    Comment out the appropriate one
\newif\ifthesis
    \thesisfalse
    % \thesistrue
...
\ifthesis
    \includepdf[fitpaper,pages=-,pagecommand={}]
            % {AuxiliaryPages/front_page_english_msc_thesis_example}
            {AuxiliaryPages/front_page_english_phd_thesis_example}
\fi

\ifproposal
    \includepdf[fitpaper,pages=-,pagecommand={}]
            % {AuxiliaryPages/front_page_hebrew_msc_proposal_example}
...
\ifthesis
    ...
    % I have provided templates for both PhD and MSc theses.
        \includepdf[fitpaper,pages=-,pagecommand={}]
                % {AuxiliaryPages/front_page_hebrew_msc_thesis_example}
